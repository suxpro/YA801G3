...
/**
 * Servlet implementation class storedMoney
 */
@WebServlet("/storedMoney")
public class storedMoney extends HttpServlet {
...
//				String url = "/front/member/update_member_input.jsp";
				String url = "/front/member/storedMoney.jsp";
		...
		if ("storedMoney".equals(action)){ // 來自update_member_input.jsp的請求
...
//				MemberVO memberVO = new MemberVO();
				...
				if (!errorMsgs.isEmpty()) {
					...
					RequestDispatcher failureView = req
							.getRequestDispatcher("/front/member/storedMoney.jsp");
					failureView.forward(req, res);
					return; // 程式中斷
				}
