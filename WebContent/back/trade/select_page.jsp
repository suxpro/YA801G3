...
<body bgcolor='white'>
	...
	<ul>
		<li><a href='<%=request.getContextPath()%>/back/trade/listAllTrade.jsp'>List</a> all Trades<font
			color=blue>(byDAO).</font></li>
		<br>
		<br>

		<li>
			<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back/trade/trade.do">
		...
		<jsp:useBean id="dao" scope="page" class="back.trade.model.TradeDAO" />
	...
	<ul>
		<li><a href='<%=request.getContextPath()%>/back/trade/addTrade.jsp'>Add</a> a new Trade.</li>
	</ul>
