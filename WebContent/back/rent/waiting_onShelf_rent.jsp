...
<div class="table-responsive">
	<table id="listAllEmpTable" class="table table-hover"
		...
		<tr align='center' valign='middle' class="info">
			...
			<th style="text-align: center">出租人編號</th>
		...
		<c:forEach var="rentVO" items="${list}" begin="<%=pageIndex%>"
			...
			<tr align='center' valign='middle'>
				<td style="text-align: center" rowspan="2"><img width="100" height="100"
					src="<%=request.getContextPath()%>/back/rent/rent.do?rent_no=${rentVO.rent_no}&pic=pic1&action=getImg"></td>
				<td style="text-align: center"><a
					href="javascript:presses${s.index}()">${rentVO.rent_no}</a></td>
				<td style="text-align: center"><a
					href="javascript:presses2${s.index}()">${rentVO.les_no}</a></td>
				<td style="text-align: center">${rentVO.rent_name}</td>
				...
				<td style="text-align: center" rowspan="2"><%=last_mod_time_D%><br> <%=last_mod_time_T%></td>
						...
						<tr>
							<td>
								...
								<form method="post"
									...
									<input type="hidden" name="action" value="pass"> <input
										class="btnCallAjaxRent" type="button" id="pass<%=count%>"
										value="通過">
								</form>
							</td>
							<td>
								...
								<div id="dialog-form<%=count%>" title="不通過的原因">
									...
									<form method="post"
										...
										<input class="btnCallAjaxRent" type="button"
											id="fail<%=count%>" value="不通過">
									</form>
								</div>
							</td>
						</tr>
