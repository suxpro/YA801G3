...
<body bgcolor='white'>
	...
	<ul>
		<li><a href='<%=request.getContextPath()%>/back/prent/listAllPrent.jsp'>List</a> all Trades<font
			color=blue>(byDAO).</font></li>
		<br>
		<br>

		<li>
			<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back/prent/prent.do">
				<b>輸入預租編號 (如P10001):</b> 
		...
		<jsp:useBean id="dao" scope="page" class="back.prerent.model.PrentDAO" />
	...
	<ul>
		<li><a href='<%=request.getContextPath()%>/back/prent/addPrent.jsp'>Add</a> a new Prent.</li>
	</ul>
