...
<body bgcolor='white'>
	<table border='1' cellpadding='5' cellspacing='0' width='400'>
		<tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
			<td>
				<h3>預租資料修改 - update_prent_input.jsp</h3> <a href="<%=request.getContextPath()%>/back/prent/select_page.jsp"><img
	...
	<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back/prent/prent.do" name="form1"
