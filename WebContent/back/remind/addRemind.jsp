...
<title>提醒資料新增 - addRemind.jsp</title>
</head>
...
<body bgcolor='white'>
	<table border='1' cellpadding='5' cellspacing='0' width='400'>
		<tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
			<td>
				<h3>提醒資料新增 - addRemind.jsp</h3>
			</td>
			<td><a href="<%=request.getContextPath()%>/back/remind/select_page.jsp"><img src="images/tomcat.gif"
		...
		<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back/remind/remind.do" name="form1"
