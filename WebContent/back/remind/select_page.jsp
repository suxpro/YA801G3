...
<body bgcolor='white'>
	...
	<ul>
		<li><a href='<%=request.getContextPath()%>/back/remind/listAllRemind.jsp'>List</a> all Remind<font
			color=blue>(byDAO).</font></li>
		<br>
		<br>

		<li>
			<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back/remind/remind.do">
		...
		<jsp:useBean id="dao" scope="page" class="back.remind.model.RemindDAO" />
	...
	<ul>
		<li><a href='<%=request.getContextPath()%>/back/remind/addRemind.jsp'>Add</a> a new Remind.</li>
	</ul>
