...
// />').find('input').focus().bind("blur",{test:tdTextBak},function(event) {
//				
...
// var array =tdFirst.nextAll().map(function () { return
// $(this).text();}).toArray();
// // console.log(array);
// jsonObj[str] = array;
// // }
...
// $("#listAllEmpTable tbody tr
// td:contains("+$("#inputListAllEmpSearch").val()+")").parent("tr").fadeIn("fast");
// });
// } else {
// $("#listAllEmpTable tbody tr").hide(function() {
// var selectPage = $(".liListAllEmpPage.disabled").text();
// console.log(selectPage);
// // $("#listAllEmpTable tbody tr:gt("+(showPage-1)+")").fadeIn("fast");
// //顯示第一頁筆數
// $("#listAllEmpTable tbody tr").each(function(){
