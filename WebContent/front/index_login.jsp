	...
	<div class="navbar navbar-inverse navbar-static-top" role="navigation">
		<div class="container">
			...
			<div class="navbar-collapse collapse navbar-form navbar-right">
				...
				<button class="btn btn-danger" onclick="location.href='<%=request.getContextPath()%>/front/member/addMember.jsp'">註冊</button>
			</div>
			<!--/.navbar-collapse -->
		</div>
	</div>
...
<div class="nav-controller">
    <span class="[ glyphicon glyphicon glyphicon-th-list ] controller-open"></span>
		...
		<div class="row row-offcanvas row-offcanvas-light">
			...
			<div class="col-xs-6 col-xs-3 sidebar-offcanvas navbar-right"
				...
				<div class="list-group">
					<a href="#" class="list-group-item active">即時SOS訊息</a> 
					<a href="<%=request.getContextPath()%>/front/member/select_page.jsp" class="list-group-item">會員</a> 
					<a href="<%=request.getContextPath()%>/front/prent/select_page.jsp"  class="list-group-item">預租</a> 
					<a href="<%=request.getContextPath()%>/front/remind/select_page.jsp" class="list-group-item">提醒</a> 
					<a href="<%=request.getContextPath()%>/front/report/select_page.jsp" class="list-group-item">檢舉</a> 
					<a href="<%=request.getContextPath()%>/front/trade/select_page.jsp"  class="list-group-item">交易</a> 
					<a href="<%=request.getContextPath()%>/front/member/select_page.jsp" class="list-group-item">Link</a> 
					<a href="<%=request.getContextPath()%>/front/member/select_page.jsp" class="list-group-item">Link</a> 
					<a href="<%=request.getContextPath()%>/front/member/select_page.jsp" class="list-group-item">Link</a> 
					<a href="<%=request.getContextPath()%>/front/member/select_page.jsp" class="list-group-item">Link</a>
				</div>
	...
	<div class="row">
		<div class='list-group gallery'>
            <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                <a class="thumbnail fancybox" rel="ligthbox" href="img/things/34669_PE124756_S3.JPG">
                    <img class="img-responsive" alt="" src="img/things/34669_PE124756_S3.JPG" />
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-xs-3">
					...
					<p>
					<a class="btn btn-default" href="#" role="button">更多
						&raquo;</a>
					</p>
