...
<ul>
  <li><a href='<%=request.getContextPath()%>/front/member/listAllMember.jsp'>List</a> all Members<font color=blue>(byDAO).</font> </li><br><br>
  ...
  <jsp:useBean id="dao" scope="page" class="front.member.model.MemberDAO" />
...
<ul>
  <li><a href='<%=request.getContextPath()%>/front/member/addMember.jsp'>Add</a> a new Member.</li>
</ul>
