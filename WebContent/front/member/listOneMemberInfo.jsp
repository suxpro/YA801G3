							...
							<div class="panel-body">
								<ul class="nav nav-sidebar">
									<li class="active"><a href="#"
										onclick="document.MemInfo.submit();">會員資料</a></li>
			...
			<div class="col-md-offset-0">
				<fieldset>
					...
					<div class="col-md-5 col-md-offset-1">
						...
						<!-- 會員姓名 -->
						<div class="control-group  ">
							<label class="control-label" for="mname">會員姓名</label> <label
								class="control-label col-xs-offset-1" id="mid">${memberVO.mname}</label>
						</div>

						<!-- 會員餘額 -->
						<div class="control-group  ">
							<label class="control-label" for="mname">會員餘額</label> <label
								class="control-label col-xs-offset-1" id="mid">${memberVO.mbalance}</label>
						</div>

						<!-- 會員性別 -->
						<div class="control-group  ">
							<label class="control-label" for="msex">會員性別</label> <label
								class="control-label col-xs-offset-1" id="msex">${mem_staMap[memberVO.msex]}</label>
						</div>

						<!-- 會員等級 -->
						<div class="control-group  ">
							<label class="control-label" for="mlev">會員等級</label> <label
								class="control-label col-xs-offset-1" id="mlev">${mem_staMap[memberVO.mlev]}</label>
						</div>

						<!-- 會員評價 -->
						<div class="control-group  ">
							<label class="control-label" for="massess">會員評價</label> <label
								class="control-label col-xs-offset-1" id="massess">${memberVO.massess}</label>
						</div>

						<!-- 會員違規次數 -->
						<div class="control-group  ">
							<label class="control-label" for="millegal">違規次數</label> <label
								class="control-label col-xs-offset-1" id="millegal">${memberVO.millegal}</label>
						</div>

						<!-- 會員手機 -->
						<div class="control-group  ">
							<label class="control-label" for="mcell">會員手機</label> <label
								class="control-label col-xs-offset-1" id="mcell">${memberVO.mcell}</label>

						</div>

						<!-- 會員郵件 -->
						<div class="control-group ">
							<label class="control-label" for="mmail">會員郵件</label> <label
								class="control-label col-xs-offset-1" id="mmail">${memberVO.mmail}</label>
						</div>
						...
						<!-- 會員地址 -->
						<div class="control-group ">
							<label class="control-label" for="madrs">會員地址</label> <label
								class="control-label col-xs-offset-1" id="madrs">${memberVO.madrs}</label>
						</div>

						<!-- 會員驗證 -->
						<div class="control-group  ">
							<label class="control-label" for="mverification">會員驗證</label> <label
								class="control-label col-xs-offset-1" id="mverification">${mem_staMap[memberVO.mverification]}</label>
						</div>

						<!-- 會員加入日期 -->
						<div class="control-group  ">
							<label class="control-label" for="mdate">加入日期</label> <label
								class="control-label col-xs-offset-1" id="mdate">${memberVO.mdate}</label>
						</div>
						...
						<c:if test="${memberVO.mlev == 'V' }">
							...
							<div id="vipPic" class="control-group  ">
								<label id="vipPicLabel" class="control-label"
									for="password_confirm">會員輪播圖片</label>
								<div class="controls">
