		...
		<div class="row">
							...
							<div class="panel-body">
								<ul class="nav nav-sidebar">
									...
									<li class="active"><a href="#"
										onclick="document.storedMoney.submit();">會員儲值</a></li>
			...
			<div class="col-md-offset-0">
				...
				<form class="form-horizontal" id="memform" METHOD="post"
							...
							<div id="textbox" class="control-group  ">
								...
								<div class="col-xs-offset-2">
									<input type="radio" id="mbalance" name="cash" value="1000"
										checked> &nbsp;&nbsp;$&nbsp;1000 NT<br /> <input
										type="radio" id="mbalance" name="cash" value="3000">
									&nbsp;&nbsp;$&nbsp;3000 NT<br /> <input type="radio"
										id="mbalance" name="cash" value="5000">
									&nbsp;&nbsp;$&nbsp;5000 NT<br /> <input type="radio"
										id="mbalance" name="cash" value="10000">
									&nbsp;&nbsp;$&nbsp;10000 NT<br /> <input type="radio"
										id="mbalance" name="cash" value="30000">
									&nbsp;&nbsp;$&nbsp;30000 NT<br /> <input type="radio"
										id="mbalance" name="cash" value="50000">
									&nbsp;&nbsp;$&nbsp;50000 NT<br />
								</div>
								<br /> <br />
							</div>
							...
							<div id="textbox" class="control-group  ">
								...
								<div class="col-xs-offset-1">
									...
									<input type="radio" value="card" name="money"
										onclick="showBank()">信用卡付款 <input type="radio"
										value="atm" name="money" onclick="showCard()">ATM

									<div style='display: none' id="atm">
										銀行代號：<input type="text" name="aNum"><br /> 扣款代號：<input
											type="text" name="sA">
									</div>
						...
						<div class="control-group col-xs-9 col-xs-offset-9">
							<div class="controls">
								...
								<button type="button" class="btn btn-success"
									data-toggle="modal" data-target="#StoredBtn">儲值</button>
					...
					<!-- modal storedMoney-->
					<div class="modal fade bs-example-modal-sm" id="StoredBtn"
