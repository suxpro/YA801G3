					...
					<ul class="nav navbar-nav ">
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							<ul id="remindMain" class="dropdown-menu dropdown-menu-right" data-action="<%=request.getContextPath()%>/ScheduleServlet">
								...
								<li class="remindList"><a id="SCES_TEN" href="<%=request.getContextPath()%>/front/remind/listAllRemind.jsp"> 成功承租<font
										class="badge pull-right">0</font></a></li>
								<li class="remindList"><a id="CF_RENT" href="<%=request.getContextPath()%>/front/remind/listAllRemind.jsp"> 出租確認<font
										class="badge pull-right">0</font></a></li>
								<li class="remindList"><a id="PRENT" href="<%=request.getContextPath()%>/front/remind/listAllRemind.jsp"> 預約通知<font
										class="badge pull-right">0</font></a></li>
								<li class="remindList"><a id="NTC_SHIP" href="<%=request.getContextPath()%>/front/remind/listAllRemind.jsp"> 出貨通知<font
										class="badge pull-right">0</font></a></li>
								<li class="remindList"><a id="NTC_LEASE" href="<%=request.getContextPath()%>/front/remind/listAllRemind.jsp"> 租期通知<font
										class="badge pull-right">0</font></a></li>
...
<!-- 										class="badge pull-right">0</font></a></li> -->
								...
								<li class="remindList"><a id="OT" href="<%=request.getContextPath()%>/front/remind/listAllRemind.jsp"> 逾期通知<font
										class="badge pull-right">0</font></a></li>
								<li class="remindList"><a id="CC_ORD" href="<%=request.getContextPath()%>/front/remind/listAllRemind.jsp"> 取消訂單<font
										class="badge pull-right">0</font></a></li>
								<li class="remindList"><a id="SELL_PASS" href="<%=request.getContextPath()%>/front/remind/listAllRemind.jsp"> 上架通過<font
										class="badge pull-right">0</font></a></li>
								<li class="remindList"><a id="SELL_NO_PASS" href="<%=request.getContextPath()%>/front/remind/listAllRemind.jsp">上架不通過<font
										class="badge pull-right">0</font></a></li>
								<li class="remindList"><a href="<%=request.getContextPath()%>/front/remind/listAllRemind.jsp"> 訂單結案<font
										class="badge pull-right">0</font></a></li>
								<li class="remindList"><a href="<%=request.getContextPath()%>/front/remind/listAllRemind.jsp"> 追蹤提醒<font
										class="badge pull-right">0</font></a></li>
