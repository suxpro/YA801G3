...
<body bgcolor='white'>
	...
	<ul>
		<li><a href='<%=request.getContextPath()%>/front/report/listAllReport.jsp'>List</a> all Reports<font
		...
		<jsp:useBean id="dao" scope="page" class="front.report.model.ReportDAO" />
	...
	<ul>
		<li><a href='<%=request.getContextPath()%>/front/report/addReport.jsp'>Add</a> a new Report.</li>
	</ul>
