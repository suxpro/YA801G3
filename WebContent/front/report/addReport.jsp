...
<body bgcolor='white'>
	<table border='1' cellpadding='5' cellspacing='0' width='400'>
		<tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
			...
			<td><a href="<%=request.getContextPath()%>/front/report/select_page.jsp"><img src="images/tomcat.gif"
		...
		<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/front/report/report.do" name="form1" enctype="multipart/form-data">
			<table border="0">
