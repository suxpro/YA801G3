...
<body bgcolor='white'>
	...
	<table border='1' cellpadding='5' cellspacing='0' width='800'>
		<tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
			<td>
				<h3>所有提醒資料 - listAllRemind_byDAO.jsp</h3> <a href="<%=request.getContextPath()%>/front/remind/select_page.jsp"><img
	...
	<table border='1' bordercolor='#CCCCFF' width='100%'>
		...
		<c:forEach var="remindVO" items="${list}" begin="<%=pageIndex%>"
			...
			<tr align='center' valign='middle' ${(remindVO.rno==param.rno) ? 'bgcolor=#CCCCFF':''}><!--將修改的那一筆加入對比色而已-->
				...
				<td>
					<FORM METHOD="post"
						ACTION="<%=request.getContextPath()%>/front/remind/remind.do">
